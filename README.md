...
[![Stars](https://img.shields.io/github/stars/hiitechcreations/verticalProgressBar?style=social)](https://github.com/hiitechcreations/verticalProgressBar)
...
```
dependencies {
    implementation 'com.github.hiitechcreations:verticalProgressBar:+' 
}
```
